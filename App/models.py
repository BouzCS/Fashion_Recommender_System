...
class StoreOrder(models.Model):
    ...
    customer = models.ForeignKey(StoreCustomer, models.DO_NOTHING, blank=True, null=True)
...
class StoreProduct(models.Model):
    ...
    medium_image_url = models.CharField(max_length=100, blank=True, null=True)
...
class StoreShippingaddress(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'store_shippingaddress'
